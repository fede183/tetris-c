...
#define NEXT_PIECE_BLOCK_X_CENTER (NEXT_PIECE_BLOCK_X + (NEXT_PIECE_BLOCK_HORIZONTAL / 2))
#define NEXT_PIECE_BLOCK_Y_CENTER (NEXT_PIECE_BLOCK_Y + (NEXT_PIECE_BLOCK_VERTICAL / 2))
...
#define MAX_LEVEL 4
#define SCORES_PER_COMPLETE_LINES (unsigned int []) {0, 40, 100, 300, 1200}
